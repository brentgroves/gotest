...
// A string type represents the set of string values. Its value is a sequence of bytes. Strings are immutable types that is once created,
// it is not possible to change the contents of a string. The predeclared string type is string.

// 4
// Derived types

// They include (a) Pointer types, (b) Array types, (c) Structure types, (d) Union types and (e) Function types
// f) Slice types g) Interface types h) Map types i) Channel Types
